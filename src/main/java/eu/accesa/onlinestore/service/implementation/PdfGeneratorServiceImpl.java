...
public class PdfGeneratorServiceImpl implements PdfGeneratorService {
    ...
    public PdfGeneratorServiceImpl(OrderRepository orderRepository) {
...
Each element of it is a String array that can be set up like this: */
    ...
    public String convertWithStream (HashMap < String, Integer > data,Double value){
            String mapAsString = data.keySet().stream()
                    .map(key -> key + "" + data.get(key)+""+value)
